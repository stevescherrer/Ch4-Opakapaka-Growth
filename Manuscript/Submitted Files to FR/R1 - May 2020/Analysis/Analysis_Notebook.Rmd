...
generate_sensitive_data = function(data = tagdat){
  ...
  for (bin in unique(tagdat$bin)){
    ...
    sensitive_data = rbind(
                      sensitive_data, 
                      bin_data[sample(x = 1:dim(bin_data)[1], size = 200, replace = TRUE), ]
                      )
...
synthetic_sensitivity_data = generate_sensitive_data()
...
bayesian_sensitivity_fit_model_1 = jags(synthetic_sensitivity_data, 
               model.file = file.path(src_dir, "VBGF JAGS Model 1 - Prior.txt"),
               parameters.to.save =  c('Linf_mu', 'Linf_std', 'Linf_tau', 'Shape', 'k_mu', 'k_std', 'k_tau', 'rate', 'tau', 'variance'),
               DIC = T, 
...
bayesian_sensitivity_fit_model_2 = jags(synthetic_sensitivity_data, inits, 
               model.file = file.path(src_dir, "VBGF JAGS Model 2 - Prior.txt"),
               parameters.to.save =  c('Linf_mu', 'Linf_std', 'Linf_tau', 'Shape', 'k_mu', 'k_std', 'k_tau', 'rate', 'tau', 'variance'),
...
bayesian_sensitivity_fit_model_3 = jags(synthetic_sensitivity_data, inits, 
               model.file = file.path(src_dir, "VBGF JAGS Model 3 - Prior.txt"),
               parameters.to.save =  c('Linf_mu', 'Linf_std', 'Linf_tau', 'Shape', 'k_mu', 'k_std', 'k_tau', 'rate', 'tau', 'variance'),
               DIC = T, n.chains = 3, n.iter = n_iterations, n.burnin = n_burnin, n.thin = n_thin)
save.image(file.path(results_dir, 'Paka VBGF Workspace For FR Revisions.RData'))
...
## Fitting Model
bayesian_sensitivity_fit_model_4 = jags(synthetic_sensitivity_data, inits, 
               model.file = file.path(src_dir, "VBGF JAGS Model 4 - Prior.txt"),
               parameters.to.save =  c('Linf_mu', 'Linf_std', 'Linf_tau', 'Shape', 'k_mu', 'k_std', 'k_tau', 'rate', 'tau', 'variance'),
               DIC = T, n.chains = 3, n.iter = n_iterations, n.burnin = n_burnin, n.thin = n_thin)
