...
Here we'll make a plot examining the coefficient of variation for our two parameters of intrest (k_mu and linf_mu). The coefficient of variation is the parameter's deviation divided by the mean. We'll organize this in a dataframe so we can plot the results.
```{r}
...
fig2 = ggplot(cv_df, aes(x = `source of individual variability`, y = cv, col = Parameter)) + 
  geom_point() + 
